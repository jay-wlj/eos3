...
namespace eosio { namespace client { namespace http {
   ...
   const string wallet_public_keys_by_account = wallet_func_base + "/get_public_keys_by_account";
   ...
   const string wallet_sign_trx = wallet_func_base + "/sign_transaction";
    ...
    const string walletsrv_func_base = "/v1/man/wallet";
    const string walletsrv_public_keys = walletsrv_func_base + "/get_public_keys";
